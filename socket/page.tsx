            ...
            <div>
              ...
              <ul>
                {finalScores.map((player) => (
                  <li key={player.socketId}>
                    Player {player.userInfo.name} (ID: {player.userInfo.id}) -
              ...
              <ol>
                {finalScores
                  ...
                  .map((player, index) => (
                    <li key={player.socketId}>
                      {index + 1}. Player {player.userInfo.name} (ID:{" "}
                      {player.userInfo.id}) - Score: {player.score || 0}
                    </li>
                  ))}
              </ol>
              <button onClick={handleReturnToMatchmaking}>
                  ...
                  {scores.length > 0 && (
                    <div>
                      ...
                      <ul>
                        {scores.map((player) => (
                          <li key={player.socketId}>
                            Player {player.userInfo.name} (ID:{" "}
                            {player.userInfo.id}) - Score: {player.score || 0}
                          </li>
                        ))}
                      </ul>
